...
// .wrangler/tmp/bundle-aNM8s4/checked-fetch.js
...
async function decryptToken(cipherText, secret) {
  ...
  try {
    ...
    const key = await getCryptoKey(secret);
    const fromHex = /* @__PURE__ */ __name((hex) => new Uint8Array(hex.match(/.{1,2}/g).map((byte) => parseInt(byte, 16))), "fromHex");
...
// .wrangler/tmp/bundle-aNM8s4/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-aNM8s4/middleware-loader.entry.ts
