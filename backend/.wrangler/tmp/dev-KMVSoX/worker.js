...
// .wrangler/tmp/bundle-JYmYwE/checked-fetch.js
...
// worker.ts
async function getCryptoKey(secret, salt) {
...
var worker_default = {
  async fetch(request, env) {
    ...
    const allowedOrigins = [
      env.FRONTEND_URL,
      // From wrangler secrets
      "http://localhost:3000",
      "http://localhost:5173",
      // Vite default
      "https://social-media-management.pages.dev"
      // Explicitly allow pages dev
    ];
    const corsHeaders = {
...
// .wrangler/tmp/bundle-JYmYwE/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-JYmYwE/middleware-loader.entry.ts
